...
let ans1 = transform(v15, true);
if (ans1 !== a15) {
	console.error("ERROR; ans1 ", ans1, " should be ", a15);
}

let ans2 = transform(v48, false);
if (ans2 !== a48) {
	console.error("ERROR; ans2 ", ans2, " should be ", a48);
}

let tot = ans1 | ans2;
trace("tot ", tot);
if (tot !== actual) {
	console.error("ERROR; tot ", tot, " should be ", actual);
}
