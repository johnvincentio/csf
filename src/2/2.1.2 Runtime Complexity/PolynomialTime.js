...
/*
An algorithm with polynomial time complexity is one whose run time would be input size n raised to some constant power, k. 
So n^2 or n^3.

The easiest way to understand polynomial time complexity is with nested loops.
An algorithm that requires two levels of looping over an input would be O(n^2) while one requiring three levels 
of looping would be O(n^3).
...
getRunTimeOperations(hasDuplicates, [1, 2, 2, 5]);
