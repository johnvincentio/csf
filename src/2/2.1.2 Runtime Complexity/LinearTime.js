...
/*
Algorithms with linear time complexity (O(n)) have run times that are directly proportional 
to the size (n) of the input.

Given input a and input b, where b is twice as large as a, it will take a linear algorithm 
twice as long to process b compared to a.
*/
